...
export const getAdminDashboardStats = async ({ context }: { context: any }) => {
...
export const getShopDetail = async ({ data, context }: { data: { shopId: string }, context: any }) => {
  await assertSuperAdmin(context.userId);
...
export const setShopPlanManual = async ({ data, context }: { data: any, context: any }) => {
  await assertSuperAdmin(context.userId);
...
export const suspendShop = async ({ data, context }: { data: any, context: any }) => {
  await assertSuperAdmin(context.userId);
...
export const unsuspendShop = async ({ data, context }: { data: any, context: any }) => {
  await assertSuperAdmin(context.userId);
